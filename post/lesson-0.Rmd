...
If you have regular old R installed, try running the script which is available to download here: [Clifford code](/files/lesson-0-clifford.R). There is a small description on the top. You may need to install some libraries.
