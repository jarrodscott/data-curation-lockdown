...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"/img/lesson-1/syntax.png"', alt = "Some alt text", link='"/img/lesson-1/syntax.png"', caption = "Syntax highlighting of the page in Atom. Notice how headers, bold text, and hyperlinks are formatted differently.")
```
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"/img/lesson-1/browser.png"', link='"/img/lesson-1/browser.png"', alt = "Some alt text", caption = "Image of Chrome Developer tools for this page. To access the tools go to `View` > `Developer` > `Developer Tools` or on a Mac hit `command`+`option`+`i`.")
```
