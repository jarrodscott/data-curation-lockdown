...
<div id="image_map">
  <map name="map_example">
    ...
    <img src="toc.png" alt="image map example" usemap="#map_example"><figcaption>Pictoral Table of Contents.</figcaption>
</div>
...
* [RStudio IDE Cheatsheet](rstudio-ide.pdf). An overview of the RStudio IDE.
* [R Markdown Cheatsheet](rmarkdown-2.0.pdf). A general R Markdown reference.
* [Another R Markdown Cheatsheet](rmarkdown-cheatsheet.pdf). One more? There are a lot of cheatsheets.
* [R Markdown Reference Guide](rmarkdown-reference.pdf). Good section on *Chunk Options*.
...
{{< edit "https://github.com/jarrodscott/data-curation-lockdown/blob/main/content/page/resources/index.md">}}
