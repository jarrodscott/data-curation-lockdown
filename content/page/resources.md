...
<img src="img/resources/toc.png" alt="image map example" usemap="#map_example"><figcaption>Pictoral Table of Contents.</figcaption>
</div>
...
* [RStudio IDE Cheatsheet](/files/rstudio-ide.pdf). An overview of the RStudio IDE.
* [R Markdown Cheatsheet](/files/rmarkdown-2.0.pdf). A general R Markdown reference.
* [Another R Markdown Cheatsheet](/files/rmarkdown-cheatsheet.pdf). One more? There are a lot of cheatsheets.
* [R Markdown Reference Guide](/files/rmarkdown-reference.pdf). Good section on *Chunk Options*.
