...
categories: ["R"]
tags: ["R Markdown", "Markdown", "R", "plots", "MathJax"]
---
...
If you have regular old R installed, try running the script which is available to download here: [Clifford code](lesson-0-clifford.R). There is a small description on the top. You may need to install some libraries.
...
```{r, echo=FALSE}
blogdown::shortcode('edit', 'https://github.com/jarrodscott/data-curation-lockdown/blob/main/content/post/lesson-0/index.Rmd')
```
