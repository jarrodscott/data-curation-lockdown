...
We have a wide range of experience levels in this course, so the first lesson is devoted to setting up your working environment and laying down a good foundation for your projects. I would like to give everyone a chance to get everything installed and to get comfortable with these new tools before we dive in. I realize that some of you may have a lot of this done already. If you are interested in developing your skills in HTML and CSS, you can check  a fantastic tutorial I linked on the [Tutorials](/page/tutorials/). You can access that page up top in the navigation bar.  Let's begin.
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"syntax.png"', alt = "Some alt text", link='"syntax.png"', caption = "Syntax highlighting of the page in Atom. Notice how headers, bold text, and hyperlinks are formatted differently.")
```
...
> If you want to practice working in your new source code editor AND learn more HTML/CSS in the process, check out the [*Interneting is Hard*](/page/tutorials/#html--css) tutorial by Oliver James linked in the HTML/CSS section on the Tutorials page (also linked in the navigation bar up top).
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"browser.png"', link='"browser.png"', alt = "Some alt text", caption = "Image of Chrome Developer tools for this page. To access the tools go to `View` > `Developer` > `Developer Tools` or on a Mac hit `command`+`option`+`i`.")
```
...
> If you want to practice working with the dev tools of your new browser AND learn more HTML/CSS in the process, check out the [*Interneting is Hard*](/page/tutorials/#html--css) tutorial by Oliver James linked in the HTML/CSS section on the Tutorials page (also linked in the navigation bar up top).
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"git-1.png"', link='"git-1.png"', alt = "Some alt text", caption = "GitHub page for an R Markdown document. ")
```
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"git-2.png"', link='"git-2.png"', alt = "Some alt text", caption = "The commit history page. ")
```

Clicking on one of unique IDs takes you to the page that documents the changes made during that commit.

```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"git-3.png"', link='"git-3.png"', alt = "Some alt text", caption = "Documentation of some changes that occured to `0_pw_intro.Rmd` during a commit.")
```
...
```{r, echo=FALSE}
blogdown::shortcode("figure", src ='"fish.png"', link='"https://projectdigest.github.io/"', alt = "Some alt text", caption = "Screen shot of the *Data accessibilty* section from the [publication](https://royalsocietypublishing.org/doi/10.1098/rspb.2019.2367).")
```
...
```{r, echo=FALSE}
blogdown::shortcode('edit', 'https://github.com/jarrodscott/data-curation-lockdown/blob/main/content/post/lesson-1/index.Rmd')
```
