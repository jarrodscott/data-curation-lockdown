...
I already made a case for [why reproducible research is important](/2020/03/31/rationale/#transparency--reproducibility). So now lets define the term and see if we can't come up with a set of criteria that encompasses its meaning. *Reproducibility* ...
...
```{r, echo=FALSE}
blogdown::shortcode('edit', 'https://github.com/jarrodscott/data-curation-lockdown/blob/main/content/post/reproducibility.Rmd')
```
